...
SECRET_KEY = 'django-insecure-nv#84ym)-b_npuics+$*+qnf!2azk*!ppe-+c*r_lg@^_dxe_$'
...
TEMPLATES = [
    {
        ...
        'DIRS': [ BASE_DIR / 'templates' ],  # Based HTML use template directory
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
